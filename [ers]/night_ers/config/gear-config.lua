...
Config.GearData = {
    ...
    Enabled = false,
    EnableGiveWeapons = false,                   -- Enable or disable giving weapons to the player.
    EnableSetClothing = false,                   -- Enable or disable setting clothes to the player. Setting both to false will result into the NPC being useless, maybe good for decoration :)
