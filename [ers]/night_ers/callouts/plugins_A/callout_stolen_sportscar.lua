Config.Callouts["stolen_sportscar"] = {
    ...
    CalloutDescriptions = {
        "Respond immediately to a stolen sportscar; intercept the vehicle and apprehend the driver.",
        "Emergency alert: high-value sportscar reported stolen; deploy units to pursue and recover the vehicle.",
        "Urgent response required: stolen sportscar in progress; ensure the vehicle is recovered and the suspect apprehended.",
        "Critical situation: stolen sportscar; act swiftly to locate the vehicle and control the pursuit.",
        "Alert: stolen sportscar reported; immediate intervention needed to recover the vehicle and maintain public safety.",
        "Vehicle theft incident: sportscar stolen; urgent action required to intercept the driver and recover the car.",
        "Handle a situation involving a stolen sportscar; prioritize recovery and coordination with pursuing units.",
        "Emergency situation: sportscar stolen; ensure the pursuit is managed safely and assist in recovering the vehicle.",
        "Urgent alert: stolen sportscar; respond quickly to manage the pursuit and recover the vehicle.",
        "Critical response needed: stolen sportscar; secure the area, recover the car, and apprehend the suspect.",
    },
