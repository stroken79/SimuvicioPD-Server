Config.Callouts["officer_assist"] = {
    ...
    CalloutDescriptions = {
        "Ha surgido una situacion que requiere respaldo inmediato para un oficial.",
        "Se necesita asistencia de emergencia para abordar un problema de aplicacion de la ley.",
        "Los informes indican una situacion urgente en la que se requiere apoyo adicional para un oficial.",
        "Ha ocurrido un incidente que requiere respaldo de un oficial, garantizando su seguridad.",
        "Se ha convocado a los servicios de emergencia para ayudar a un agente en una situacion critica.",
        "Un oficial ha realizado una solicitud de asistencia en una situacion potencialmente peligrosa.",
        "Se necesitan recursos adicionales para apoyar a un oficial que enfrenta una situacion en aumento.",
        "Se requiere respaldo de emergencia para ayudar a un oficial a enfrentar una circunstancia imprevista.",
        "Un oficial ha emitido una llamada de asistencia que requiere respaldo inmediato.",
        "Los informes sugieren una situacion en la que un oficial requiere asistencia urgente para mantener el control.",
    },
