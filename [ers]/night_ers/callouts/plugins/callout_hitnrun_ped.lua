Config.Callouts["hitnrun_ped"] = {
    ...
    CalloutDescriptions = {
        "Responder inmediatamente a un incidente de atropello y fuga; una persona ha resultado herida y requiere atencion medica urgente.",
        "Situacion de emergencia: una persona ha resultado herida en un atropello y fuga; desplegar unidades para proporcionar ayuda e investigar la escena.",
        "Llamada urgente de auxilio: un peaton ha sido atropellado por un vehiculo en un atropello y fuga; priorizar la atencion medica y detener al sospechoso.",
        "Incidente critico: accidente de atropello y fuga ha dejado una persona herida; responder rapidamente para administrar primeros auxilios y reunir pruebas.",
        "Alerta: se reportan lesiones por atropello y fuga; enviar servicios de emergencia al lugar e iniciar una investigacion.",
        "Emergencia medica: una persona ha resultado herida en una colision de atropello y fuga; Se requiere una respuesta inmediata para estabilizar a la victima.",
        "Responder a un accidente de atropello y fuga; una persona resulta herida y necesita asistencia medica inmediata e intervencion policial.",
        "Informe de incidente: atropello y fuga con heridos; coordinar la respuesta medica de emergencia y comenzar la persecucion del sospechoso.",
        "Se necesita atencion inmediata: un incidente de atropello y fuga ha herido a un peaton; desplegar unidades para brindar asistencia medica y asegurar el area.",
        "Aviso urgente: una persona ha resultado herida en un atropello y fuga; responder rapidamente para brindar atencion medica e iniciar la investigacion.",
    },            
