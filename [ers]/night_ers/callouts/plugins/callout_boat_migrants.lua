Config.Callouts["boat_migrants"] = {
    ...
    CalloutDescriptions = {
        "Investigar informes sobre migrantes que llegan en barco; asegurar el area y garantizar su seguridad.",
        "Alerta: enviar unidades para responder a informes de migrantes que llegan en barco; proporcionar asistencia inmediata.",
        "Unidades requeridas: responder a informes de un barco que transporta migrantes y tomar las acciones necesarias para ayudarlos.",
        "Aviso: consultar informes de migrantes llegados en embarcacion; implementar medidas para garantizar su bienestar.",
        "Alerta: responder con prontitud a los informes de migrantes que llegan en barco; priorizar su seguridad y cuidado.",
        "Incidente reportado: investigue los informes de migrantes que llegan en un barco para brindar la ayuda y el apoyo necesarios.",
        "Investigar informes sobre un barco que transportaba migrantes; coordinar con las autoridades pertinentes para abordar la situacion.",
        "Alerta de situacion: atender informes de migrantes que llegan en embarcacion; asegurese de que el area este asegurada y se brinde ayuda.",
        "Alerta: manejar reportes de migrantes que llegan en embarcacion y seguir protocolos para garantizar su seguridad y apoyo.",
        "Se necesita respuesta: investigar los informes de migrantes que llegan en un barco y tomar las medidas apropiadas para ayudarlos y protegerlos.",
    },                
