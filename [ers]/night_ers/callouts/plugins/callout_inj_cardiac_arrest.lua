Config.Callouts["inj_cardiac_arrest"] = {
    ...
    CalloutDescriptions = {
        "Se ha producido un paro cardiaco que requiere atencion medica inmediata.",
        "Se necesita asistencia medica de emergencia para abordar una situacion de paro cardiaco.",
        "Los informes indican un incidente de paro cardiaco que requirio una intervencion medica urgente.",
        "Se ha informado de un paro cardiaco y se necesita apoyo medico para estabilizar al paciente.",
        "Se ha solicitado a los servicios de emergencia que atiendan una situacion de paro cardiaco.",
        "El personal que respondio a un paro cardiaco ha realizado una solicitud de asistencia medica.",
        "Se requieren unidades medicas adicionales para apoyar al personal que responde a un paro cardiaco.",
        "Se requiere respaldo de emergencia para ayudar al personal medico a estabilizar a un paciente que sufre un paro cardiaco.",
        "El personal que se ocupa de un paro cardiaco ha emitido una llamada de asistencia.",
        "Los informes sugieren una situacion de paro cardiaco en la que la asistencia medica inmediata es crucial para salvar una vida.",
    },
