Config.Callouts["house_fire"] = {
    ...
    CalloutDescriptions = {
        "Se ha informado de un incendio en una casa que requiere atencion inmediata de los bomberos.",
        "Se necesitan servicios de emergencia para extinguir un incendio en una casa.",
        "Los informes indican que se ha producido un incendio en una casa, lo que requiere una intervencion urgente de los bomberos.",
        "Se ha identificado un incendio en una casa y se necesita personal de bomberos adicional para contenerlo y extinguirlo.",
        "Se ha solicitado a los servicios de emergencia que respondan a un incendio en una casa.",
        "Las autoridades que se ocupan de un incendio en una casa han solicitado ayuda.",
        "Se requieren unidades adicionales para apoyar al personal de bomberos en la gestion de un incendio domestico.",
        "Se requiere respaldo de emergencia para ayudar a las autoridades de bomberos a manejar un incendio en una casa.",
        "Los socorristas que se ocupan de un incendio en una casa han emitido un llamado de ayuda.",
        "Los informes sugieren una situacion en la que la intervencion inmediata de los bomberos es crucial para gestionar y abordar un incendio domestico.",
    },                                 
