Config.Callouts["atm_robbery"] = {
    ...
    CalloutDescriptions = {
        "Se esta produciendo un robo a un cajero automatico que requiere una respuesta policial inmediata.",
        "Se necesita asistencia de emergencia para detener a los sospechosos involucrados en el robo de un cajero automatico.",
        "Los informes indican que se esta produciendo un robo a un cajero automatico, lo que requiere una intervencion policial urgente.",
        "Se ha producido un robo en un cajero automatico y se necesitan refuerzos para asegurar el area y detener a los sospechosos.",
        "Los servicios de emergencia han sido enviados para atender una situacion de robo en un cajero automatico.",
        "Los agentes que respondieron a un robo en un cajero automatico realizaron una solicitud de asistencia.",
        "Se requieren unidades adicionales para apoyar a los oficiales que responden a un robo de cajero automatico.",
        "Se requiere respaldo de emergencia para ayudar a los oficiales a detener a los sospechosos involucrados en el robo de un cajero automatico.",
        "Los agentes que se ocupan de un robo en un cajero automatico han emitido una llamada de ayuda.",
        "Los informes sugieren una situacion de robo de cajero automatico en la que la asistencia policial inmediata es crucial para evitar danos mayores.",
    },            
