Config.Callouts["train_derailed"] = {
    ...
    CalloutDescriptions = {
        "Un tren descarrilo y fue necesaria la intervencion inmediata de los servicios de emergencia.",
        "Se necesitan equipos de emergencia para ayudar en caso de incidente de tren descarrilado.",
        "Las autoridades informan de un descarrilamiento de un tren, lo que requiere medidas urgentes para asegurar la zona.",
        "Un tren se ha descarrilado y se necesitan unidades adicionales para gestionar la situacion.",
        "Se requiere respuesta inmediata ante el descarrilamiento de un tren que pone en peligro las zonas aledanas.",
        "Un tren descarrilado esta bloqueando las vias y se necesitan refuerzos para ayudar a las autoridades locales.",
        "Los equipos de emergencia solicitan refuerzos para hacer frente a las consecuencias del descarrilamiento de un tren.",
        "Se ha hecho una llamada urgente de ayuda para hacer frente a un tren que ha descarrilado.",
        "Los socorristas se encuentran en el lugar del descarrilamiento de un tren y necesitan apoyo adicional para evitar danos mayores.",
        "Un importante descarrilamiento de un tren exige una intervencion inmediata para proteger vidas y restablecer el orden.",
    },                                          
