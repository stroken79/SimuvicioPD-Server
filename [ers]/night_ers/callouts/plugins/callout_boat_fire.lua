Config.Callouts["boat_fire"] = {
    ...
    CalloutDescriptions = {
        "Los servicios de emergencia deben extinguir las llamas que envuelven un barco.",
        "Las autoridades informan de un barco en llamas y exigen una intervencion inmediata para garantizar la seguridad.",
        "Se ha informado de un incendio en un barco, lo que requiere medidas urgentes para evitar danos mayores.",
        "Situacion critica con barco en llamas; Se necesitan unidades adicionales para apoyo.",
        "Se necesita una respuesta inmediata para hacer frente a un barco envuelto en llamas.",
        "Un barco esta ardiendo, lo que representa una grave amenaza; Se necesitan refuerzos para contener el fuego.",
        "Los equipos de emergencia solicitan refuerzos para ayudar a controlar el incendio de un barco y evitar su propagacion.",
        "Se ha emitido un llamado urgente de ayuda para atender un barco envuelto en llamas y garantizar la seguridad.",
        "Los socorristas se encuentran en la escena del incendio de un barco y necesitan apoyo adicional para controlar el incendio.",
        "Una emergencia grave que involucra un barco en llamas exige una accion rapida para evitar una escalada.",
    },                             
