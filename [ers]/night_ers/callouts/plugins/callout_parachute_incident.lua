Config.Callouts["parachute_incident"] = {
    ...
    CalloutDescriptions = {
        "Responder inmediatamente a un informe de un paracaidista en peligro; asegurar la zona y proporcionar la asistencia necesaria.",
        "Alerta de emergencia: paracaidista en problemas; desplegar unidades para gestionar la situacion y garantizar su seguridad.",
        "Se requiere una respuesta urgente: el paracaidista ha encontrado un problema; centrarse en las operaciones de rescate y asistencia medica.",
        "Situacion critica: paracaidista en peligro; actuar rapidamente para brindar ayuda y asegurar la escena.",
        "Alerta: reportan emergencia de paracaidista; Se necesita intervencion inmediata para ayudar al individuo y garantizar su seguridad.",
        "Incidente paracaidista: se requiere actuacion urgente para asegurar la zona y prestar ayuda al afectado.",
        "Manejar una emergencia de paracaidista; priorizar los esfuerzos de rescate y coordinar con los equipos de emergencia.",
        "Situacion de emergencia: paracaidista en problemas; Asegurese de que el area sea segura y ayude en la operacion de rescate.",
        "Alerta urgente: llamada de socorro de paracaidista; responder rapidamente para gestionar la escena y proporcionar el apoyo necesario.",
        "Se necesita una respuesta critica: incidente del paracaidista; asegurar el area, ayudar al individuo y garantizar su seguridad.",
    },                   
