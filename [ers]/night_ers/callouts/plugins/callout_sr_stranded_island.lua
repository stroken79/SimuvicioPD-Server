Config.Callouts["sr_stranded_island"] = {
    ...
    CalloutDescriptions = {
        "Un individuo herido queda varado en una isla; Los equipos de rescate estan en camino.",
        "Se necesita urgentemente personal medico para atender a un herido aislado en una isla.",
        "Se han desplegado unidades de rescate para ayudar a un herido encontrado en una isla.",
        "Se esta llevando a cabo una operacion critica de rescate para un individuo herido en una isla.",
        "Se requiere una rapida intervencion medica para una persona herida y varada en una isla.",
        "Los socorristas corren contra el tiempo para salvar a una persona herida en una isla.",
        "Se ha hecho un llamado de ayuda para rescatar a un herido abandonado en una isla.",
        "Los equipos de respuesta de emergencia se dirigen a una isla para ayudar a un herido.",
        "Una persona en apuros ha sido localizada en una isla; Se necesitan esfuerzos de rescate inmediatos.",
        "Se requiere asistencia urgente para una persona herida en una isla; Se movilizaron equipos de rescate.",
    },                                             
