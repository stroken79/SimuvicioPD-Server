Config.Callouts["animal_lion_loose"] = {
    ...
    CalloutDescriptions = {
        "Responder a un informe de un leon suelto; garantizar la seguridad publica y coordinar con el control de animales.",
        "Alerta: leon salvaje avistado en la zona; desplegar unidades para contener al animal y proteger a los civiles.",
        "Unidades necesarias: llamada de emergencia por un leon suelto; concentrese en asegurar el area y prevenir cualquier dano.",
        "Aviso: leon reportado deambular libremente; actuar con prontitud para controlar la situacion y prestar asistencia.",
        "Alerta: reporte de un leon suelto; intervencion necesaria para asegurar el lugar y garantizar la seguridad.",
        "Incidente reportado: leon avistado en las cercanias; tomar medidas para brindar respuesta y apoyo urgentes.",
        "Responder a una situacion que involucre a un leon suelto; priorizar la seguridad publica y coordinar con expertos en vida silvestre.",
        "Alerta de situacion: leon suelto; proporcionar asistencia inmediata y garantizar que el area sea segura.",
        "Alerta: reporte de un leon vagando libremente; responder rapidamente para abordar la emergencia y ofrecer el apoyo necesario.",
        "Se necesita respuesta: leon suelto; garantizar la seguridad publica, proporcionar ayuda y asegurar la zona.",
    },                                                         
