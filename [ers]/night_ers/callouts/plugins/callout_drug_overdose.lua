Config.Callouts["drug_overdose"] = {
    ...
    CalloutDescriptions = {
        "Individuo encontrado con signos de sobredosis de drogas; Se necesitan paramedicos con urgencia.",
        "Un testigo informa que una persona presenta sintomas de sobredosis; Se requiere ayuda inmediata.",
        "Alerta de emergencia: sospecha de sobredosis de drogas en el lugar; Se necesita una respuesta medica rapida.",
        "Las autoridades llamaron a una posible victima de sobredosis; Se solicitaron equipos medicos adicionales.",
        "Persona caida por una aparente sobredosis; Se necesita una respuesta urgente de los servicios de emergencia.",
        "Se requiere asistencia inmediata en un caso de sobredosis; Se notan signos de reaccion grave.",
        "Se reporta situacion critica de sobredosis; apoyo medico de emergencia esencial.",
        "Se solicita ayuda medica urgente para un individuo sospechoso de sobredosis de drogas.",
        "Llamada recibida sobre sobredosis de drogas; Persona en estado critico, necesita paramedicos ahora.",
        "Emergencia medica: sospecha de sobredosis; Se necesita una intervencion urgente para salvar vidas.",
    },                     
