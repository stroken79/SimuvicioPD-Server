...
ConvarEnableLaMesaMatus = false -- https://esx-scripts.com/de/shop/san-andreas-highway-patrol-mlo/
ConvarEnableDelPerroPablito = false -- https://de.gta5-mods.com/maps/del-perro-police-department-mlo-add-on-fivem
...
ConvarEnableMainScript = false -- Enables Interaction with peds, radialmenu and many other scripts. If deactivated markers still function properly.
ConvarEnableMissionScript = false -- Enables Ambient Events; only works with main script enabled
