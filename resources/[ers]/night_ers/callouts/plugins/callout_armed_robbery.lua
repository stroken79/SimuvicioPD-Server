Config.Callouts["armed_robbery"] = {
    ...
    CalloutDescriptions = {
        "Responder a una denuncia de robo a mano armada; Asegure el area y detenga al sospechoso.",
        "Alerta: robo a mano armada en curso; desplegar unidades en el lugar y garantizar la seguridad publica.",
        "Unidades necesarias: denuncia de robo con arma; concentrese en asegurar la escena y detener al sospechoso.",
        "Aviso: se reporta robo a mano armada; actuar con prontitud para controlar la situacion y prevenir danos.",
        "Alerta: reporte de robo a mano armada; Intervencion necesaria para detener al sospechoso y garantizar su seguridad.",
        "Incidente reportado: robo a mano armada; tomar medidas para asegurar las instalaciones y proteger a los transeuntes.",
        "Responder a una situacion que involucre un robo a mano armada; priorizar la seguridad publica y coordinar con las autoridades.",
        "Alerta de situacion: robo a mano armada en curso; Asegure el area y detenga al sospechoso.",
        "Alerta: reporte de robo con arma; responder rapidamente para abordar la situacion y garantizar la seguridad.",
        "Se necesita respuesta: robo a mano armada; asegurar el area, detener al sospechoso y restablecer el orden.",
    },                                
