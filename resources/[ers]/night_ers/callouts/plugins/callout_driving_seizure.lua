Config.Callouts["driving_seizure"] = {
    ...
    CalloutDescriptions = {
        "La persona que llama informa que un conductor esta experimentando una convulsion y se requiere asistencia medica inmediata.",
        "Llamada de emergencia: conductor en peligro debido a un ataque, vehiculo fuera de control, se necesita ayuda urgente.",
        "¡Emergencia! El conductor informo haber tenido una convulsion mientras conducia, un posible accidente inminente.",
        "Un testigo informa que el conductor tuvo una convulsion, el vehiculo se desvio peligrosamente y se necesita intervencion inmediata.",
        "Se necesita ayuda: el conductor sufre un ataque, el coche se ha detenido en el trafico.",
        "Urgente: se informo convulsion al volante, posibilidad de accidente grave, se requiere asistencia medica.",
        "La persona que llama indica que un conductor esta experimentando una convulsion, que el vehiculo se detuvo en una posicion peligrosa y que se necesitan servicios de emergencia.",
        "Situacion grave: el conductor informo haber tenido una convulsion, el automovil bloqueo la carretera y se necesitaba asistencia inmediata.",
        "Un testigo informa una emergencia medica: el conductor tiene una convulsion, posibilidad de accidente, se necesitan socorristas.",
        "Informe de un conductor que sufrio una convulsion, vehiculo fuera de control, se necesita respuesta medica y policial urgente.",
    },                               
