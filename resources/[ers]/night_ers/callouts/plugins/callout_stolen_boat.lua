Config.Callouts["stolen_boat"] = {
    ...
    CalloutDescriptions = {
        "Responder a un barco robado; Se requieren acciones inmediatas para detener a los sospechosos y asegurar el barco.",
        "Se necesita respuesta de emergencia para un barco robado; desplegar unidades marinas para interceptar y recuperar el buque.",
        "Llamado urgente para atender embarcacion robada; Movilizar recursos para detener a los perpetradores y devolver el barco sano y salvo.",
        "Se reporta barco robado; responder rapidamente para evitar que el buque sea utilizado para actividades ilicitas.",
        "Alerta de incidente: barco robado; desplegar recursos policiales para perseguir y recuperar la embarcacion robada.",
        "Se requiere respuesta de emergencia para un barco robado; priorizar la detencion de sospechosos y la recuperacion del buque.",
        "Responder al incidente del barco robado; acelerar los esfuerzos para detener a los sospechosos y asegurar el barco.",
        "Se reporta barco robado; activar protocolos de emergencia y coordinar con unidades maritimas para interceptar la embarcacion.",
        "Se necesita una respuesta inmediata para un barco robado; priorizar la seguridad publica y prevenir futuras actividades delictivas.",
        "Aviso urgente: barco robado; responder con prontitud para detener a los sospechosos y salvaguardar la seguridad maritima.",
    },                                                               
