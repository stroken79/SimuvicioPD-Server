Config.Callouts["stolen_tractor"] = {
    ...
    CalloutDescriptions = {
        "Denuncias por robo de tractor, detalles pendientes",
        "Se denuncia presunto robo de un tractor; se necesita mas informacion",
        "Incidente con tractor robado, evaluar la situacion por seguridad",
        "Denuncian robo de tractor, priorizan respuesta para recuperacion",
        ...
        "Denuncias por robo de tractor, priorizan respuesta para recuperacion",
        "Reportan incidente de robo de tractor, coordinar con autoridades",
    },            
