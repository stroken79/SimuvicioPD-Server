Config.Callouts["repeated_hotline"] = {
    ...
    CalloutDescriptions = {
        "Investigar llamadas de emergencia repetidas de un individuo; garantizar su seguridad y atender cualquier necesidad urgente.",
        "Alerta: despliegue unidades para evaluar y ayudar a una persona que realiza repetidas llamadas de emergencia.",
        "Unidades requeridas: investigue multiples llamadas de emergencia desde la misma ubicacion para posibles emergencias.",
        "Aviso: verifique la naturaleza de las llamadas de emergencia persistentes y brinde el apoyo necesario.",
        "Alerta: responder a llamadas de emergencia en curso desde una zona residencial; evaluar emergencias genuinas.",
        "Incidente reportado: investigar llamadas de emergencia continuas para determinar las necesidades de quien llama.",
        "Responder a una persona que llama repetidamente a la linea directa de emergencia; priorizar la salud mental y brindar apoyo.",
        "Alerta de situacion: coordine con profesionales para ayudar a una persona que realiza repetidas llamadas de emergencia.",
        "Alerta: responder con empatia a las llamadas de emergencia persistentes y brindar la asistencia adecuada.",
        "Respuesta necesaria: investigar y atender llamadas de emergencia continuas para garantizar la seguridad y el apoyo.",
    },
