Config.Callouts["animal_on_road"] = {
    ...
    CalloutDescriptions = {
        "Un tipo inesperado de animal ha aparecido en la carretera, provocando una interrupcion en el flujo del trafico.",
        "Los servicios de emergencia han sido llamados para intervenir ante una situacion en la que un animal obstaculiza el trafico en la via.",
        "Los informes indican un disturbio en la carretera, con una criatura no identificada causando conmocion.",
        "Se ha producido un incidente peculiar en la carretera que requiere atencion inmediata para garantizar la seguridad publica.",
        "Los servicios de emergencia han sido enviados para solucionar un obstaculo en la carretera en el que se encontraba un animal.",
        "Se ha producido un encuentro sorprendente en la carretera, con una criatura desconocida que entorpece el trafico.",
        "Los testigos informan de un suceso inusual en la carretera, con un animal no identificado que crea un peligro para los automovilistas.",
        "Se ha producido un incidente en la carretera y un animal supone una amenaza potencial para los conductores.",
        "Los servicios de emergencia han sido alertados de una situacion en la que una criatura no identificada esta obstruyendo la via.",
        "Los informes sugieren un tipo inesperado de animal en el camino, que involucra a un animal que requiere asistencia inmediata.",
    },
