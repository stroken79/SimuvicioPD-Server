Config.Callouts["tree_fire"] = {
    ...
    CalloutDescriptions = {
        "Se requiere que los servicios de emergencia extingan el incendio de un arbol.",
        "Las autoridades reportan un arbol en llamas y exigen intervencion inmediata para garantizar la seguridad.",
        "Se ha informado de un incendio de arboles, lo que requiere medidas urgentes para minimizar danos mayores.",
        "Situacion critica con un arbol en llamas; Se necesitan unidades adicionales para apoyo.",
        "Se necesita una respuesta inmediata para abordar un incendio de arboles que representa un peligro inminente.",
        "Un arbol esta en llamas, lo que representa una grave amenaza; Se necesitan refuerzos para contener el incendio.",
        "Los equipos de emergencia solicitan refuerzos para ayudar a controlar el incendio de un arbol y evitar su propagacion.",
        "Se ha emitido una llamada urgente de ayuda para gestionar un incendio de arboles y garantizar la seguridad.",
        "Los socorristas se encuentran en la escena del incendio de un arbol y necesitan apoyo adicional para estabilizar la situacion.",
        "Una emergencia grave relacionada con un incendio de arboles exige una accion rapida para evitar un resultado catastrofico.",
    },               
