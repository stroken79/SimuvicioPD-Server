Config.Callouts["inj_suffocation"] = {
    ...
    CalloutDescriptions = {
        "Emergencia: investigar informes de un posible incidente de asfixia; asegurar el area y administrar primeros auxilios.",
        "Alerta urgente: enviar unidades para responder a informes de asfixia; proporcionar asistencia medica inmediata.",
        "Se requiere respuesta critica: atender informes de un caso de asfixia; realizar las acciones necesarias para salvar vidas.",
        "Aviso: consultar informes de asfixia; garantizar una intervencion medica rapida y medidas de seguridad.",
        "Alerta: responda con prontitud a los informes de asfixia; priorizar la seguridad de la victima y administrar oxigeno si es necesario.",
        "Incidente reportado: investigar informes de asfixia para prevenir resultados fatales; coordinar con los equipos medicos.",
        "Accion inmediata: atender denuncias de persona asfixiandose; implementar operaciones de rescate y garantizar la seguridad.",
        "Alerta de situacion: atender reportes de asfixia; asegurar la zona y proporcionar apoyo vital.",
        "Respuesta de emergencia: manejar informes de asfixia y seguir protocolos medicos para garantizar la supervivencia.",
        "Se necesita respuesta: investigar urgentemente los informes de asfixia; tomar medidas apropiadas para salvar vidas y prevenir danos.",
    },                      
