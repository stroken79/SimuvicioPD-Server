...
Config.Callouts["boat_engine_fail"] = {
    ...
    Enabled = true,
    Priority = 1,
    CalloutName = "Fallo del motor (barco) en mar abierto",
    CalloutDescriptions = {
        "Emergencia: responder a reportes de una embarcacion con falla de motor en mar abierto; garantizar la seguridad de todos los pasajeros.",
        "Alerta urgente: enviar unidades de rescate para ayudar a un barco que sufre una falla en el motor; proporcionar asistencia inmediata.",
        "Se requiere respuesta critica: atender un barco con falla de motor; realizar las operaciones de rescate necesarias.",
        "Aviso: consulte los informes de falla del motor de un barco; garantizar una intervencion rapida y medidas de seguridad.",
        "Alerta: responder con prontitud a los informes de un barco varado debido a una falla del motor; priorizar la seguridad de los pasajeros.",
        "Incidente reportado: investigar falla del motor en un barco para prevenir situaciones peligrosas; coordinar con las autoridades maritimas.",
        "Accion inmediata: abordar los informes de falla del motor de un barco; implementar operaciones de rescate y garantizar la seguridad.",
        "Alerta de situacion: asistir a un barco con fallo de motor; asegurar el area y brindar el apoyo necesario.",
        "Respuesta de emergencia: manejar informes de falla del motor de un barco y seguir los protocolos de rescate para garantizar la seguridad.",
