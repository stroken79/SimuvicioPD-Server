Config.Callouts["vehicle_theft"] = {
    ...
    CalloutDescriptions = {
        "Denuncias por robo de vehiculos, detalles pendientes",
        "Se reporto presunto robo de vehiculo, se necesita mas informacion",
        "Incidente con vehiculo robado, evaluar la situacion por seguridad",
        "Denuncian robo de vehiculos, priorizar respuesta para recuperacion",
        "Denuncia de robo de vehiculo motorizado, investigue con prontitud",
        "Vehiculo reportado como desaparecido, coordinar esfuerzos de busqueda y recuperacion",
        "Vehiculo robado reportado, evaluar riesgos potenciales",
        "Sospecha de robo de vehiculo, acerquese a la investigacion con precaucion",
        "Denuncias de robo de vehiculos, priorizan respuesta para recuperacion",
        "Reportan incidente de robo de vehiculo, coordinar con autoridades",
    },            
