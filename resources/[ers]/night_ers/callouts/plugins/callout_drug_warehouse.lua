Config.Callouts["drug_warehouse"] = {
    ...
    CalloutDescriptions = {
        "Emergencia: responder inmediatamente a reportes de un almacen de contrabando de drogas; Asegure el area y detenga a los sospechosos.",
        "Alerta urgente: enviar unidades al lugar de una operacion de narcotrafico; impedir que los sospechosos escapen y confiscar el contrabando.",
        "Respuesta critica: atender reporte de almacen de narcotrafico; priorizar la obtencion de pruebas y la detencion de todos los involucrados.",
        "Accion inmediata: investigar informes sobre un almacen de contrabando de drogas; tomar las medidas necesarias para cerrar la operacion.",
        "Alerta: responder con prontitud al descubrimiento de un almacen de contrabando de drogas; garantizar la seguridad de los agentes y reunir todas las pruebas.",
        "Incidente reportado: manejar una situacion que involucra un almacen de contrabando de drogas; coordinar con las unidades antinarcoticos para gestionar la operacion.",
        "Alerta de situacion: ayudar en el allanamiento de un almacen de contrabando de drogas; Asegure el lugar y arreste a todos los sospechosos.",
        "Respuesta de emergencia: ocuparse de un almacen de contrabando de drogas descubierto; seguir protocolos para incautar drogas y arrestar personas.",
        "Intervencion inmediata: responder a denuncias de almacen de narcotrafico; priorizar la detencion de sospechosos y la confiscacion de sustancias ilegales.",
        "Se necesita respuesta: investigar urgentemente los informes sobre una operacion de trafico de drogas; tomar las acciones apropiadas para desmantelar la operacion y asegurar el area.",
    },                                                                                 
