Config.Callouts["road_rage"] = {
    ...
    CalloutDescriptions = {
        "Emergencia: responder a informes de un incidente de violencia en la carretera; garantizar la seguridad de todas las personas involucradas y reducir la situacion.",
        "Alerta urgente: enviar unidades al lugar de un altercado de violencia en la carretera; prevenir la escalada y mantener la seguridad publica.",
        "Se requiere una respuesta critica: atender los informes de violencia en la carretera; asegurar la zona y mediar en el conflicto.",
        "Aviso: consulte los informes de violencia en la carretera; tomar medidas inmediatas para resolver el altercado y proteger a los transeuntes.",
        "Alerta: responder con prontitud a un incidente de violencia en la carretera; priorizar la seguridad de conductores y pasajeros, y restablecer el orden.",
        "Incidente reportado: investigar una situacion de furia en la carretera; coordinar con las autoridades locales para gestionar el conflicto de forma eficaz.",
        "Accion inmediata: abordar los informes de violencia en la carretera; utilizar las medidas necesarias para calmar la situacion y garantizar la seguridad.",
        "Alerta de situacion: ayudar a resolver un incidente de furia en la carretera; garantizar que el area sea segura y brindar el apoyo necesario.",
        "Respuesta de emergencia: manejar informes de violencia en la carretera; Siga los protocolos para reducir la situacion y garantizar la seguridad para todos.",
        "Se necesita respuesta: investigar con urgencia los informes de un incidente de violencia en la carretera; tomar medidas apropiadas para prevenir danos y restablecer la paz.",
    },                                                          
