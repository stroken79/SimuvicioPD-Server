Config.Callouts["highway_pileup"] = {
    ...
    CalloutDescriptions = {
        "Responder inmediatamente a un choque de varios vehiculos en la carretera; asegurar el area y brindar asistencia a los involucrados.",
        "Alerta de emergencia: choque importante en la carretera; desplegar unidades para gestionar la escena y garantizar la seguridad de todos los automovilistas.",
        "Se requiere una respuesta urgente: varios vehiculos involucrados en un choque en la carretera; centrarse en las operaciones de rescate y control del trafico.",
        "Situacion critica: choque en carretera con varios vehiculos; actuar rapidamente para proporcionar ayuda y evitar nuevos incidentes.",
        "Alerta: se reporta un choque importante en la carretera; Se necesita intervencion inmediata para ayudar a los heridos y retirar los escombros.",
        "Incidente en la carretera: choque de varios vehiculos; Se requieren medidas urgentes para asegurar el lugar y ayudar a los conductores afectados.",
        "Maneja un choque grave en la carretera; priorizar la respuesta de emergencia y coordinar con los equipos de rescate.",
        "Situacion de emergencia: colision de varios vehiculos en la carretera; garantizar que el area sea segura y ayudar en los esfuerzos de rescate.",
        "Alerta urgente: choque importante en la carretera; responder rapidamente para gestionar la escena y proporcionar la ayuda necesaria.",
        "Se necesita una respuesta critica: choque en la carretera que involucra a numerosos vehiculos; asegurar el area, ayudar a los heridos y restablecer el flujo de trafico.",
    },               
