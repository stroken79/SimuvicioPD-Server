...
Config.Callouts["traffic_incident"] = {
    ...
    CalloutDescriptions = {
        "Colision de trafico notificada; se necesitan mas detalles",
        "Colision que involucra vehiculos, evalue la escena por seguridad",
        "Se informo de un incidente en la carretera, la magnitud de los danos no esta clara",
        "Incidente de transito con heridos desconocidos, acerquese con precaucion",
        "Colision de vehiculo reportada, se requiere asistencia",
        "Escena del accidente identificada, evaluar para respuesta de emergencia",
        "Colision en calzada, prioriza la seguridad y la asistencia",
        "Incidente de trafico reportado, coordinar la respuesta en consecuencia",
        "Carretera bloqueada debido a colision, evaluar los peligros",
        "Colision de vehiculo con lesiones no especificadas, se necesita respuesta",
