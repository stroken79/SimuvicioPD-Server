Config.Callouts["sr_wounded_hiker"] = {
    ...
    CalloutDescriptions = {
        "Los servicios de emergencia han localizado a un excursionista herido en una montana y estan brindando asistencia.",
        "Las autoridades informan que un excursionista herido fue encontrado en una montana y requiere atencion medica inmediata.",
        "Un excursionista herido ha sido localizado en una montana, por lo que es necesario actuar urgentemente para garantizar su seguridad.",
        "Situacion critica con un excursionista herido localizado en una montana; Se necesita personal medico para apoyo.",
        "Se necesita una respuesta inmediata para brindar asistencia medica al excursionista herido en la montana.",
        "Un excursionista herido ha sido encontrado en una montana, lo que representa una grave amenaza para su salud; Se necesitan refuerzos medicos.",
        "Los equipos de emergencia estan solicitando apoyo medico para ayudar a brindar atencion al excursionista herido en la montana.",
        "Se ha emitido un llamado urgente de ayuda para atender a un excursionista herido en una montana y garantizar su bienestar.",
        "Los socorristas estan en el lugar con un excursionista herido en una montana y necesitan apoyo adicional para brindarle la atencion necesaria.",
        "Una emergencia grave que involucra a un excursionista herido en una montana exige una accion rapida para brindar atencion medica y garantizar su recuperacion.",
    },                                       
