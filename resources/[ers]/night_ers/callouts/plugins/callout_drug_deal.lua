Config.Callouts["drug_deal"] = {
    ...
    CalloutDescriptions = {
        "Se ha informado de una posible situacion de trafico de drogas que requiere una respuesta policial inmediata.",
        "Se necesita asistencia de emergencia para investigar y abordar un posible escenario de trafico de drogas.",
        "Los informes indican una posible actividad de trafico de drogas, que requiere una intervencion policial urgente.",
        "Se ha informado de una posible situacion de trafico de drogas y se necesita apoyo para asegurar el area y realizar una investigacion.",
        "Se han enviado servicios de emergencia para abordar una posible situacion de trafico de drogas.",
        "Los agentes que respondieron a un posible incidente de trafico de drogas han realizado una solicitud de asistencia.",
        "Se requieren unidades adicionales para apoyar a los oficiales que responden a una posible situacion de trafico de drogas.",
        "Se requiere respaldo de emergencia para ayudar a los oficiales a manejar un posible escenario de trafico de drogas.",
        "Los agentes que se ocupan de una posible situacion de trafico de drogas han emitido un llamado de ayuda.",
        "Los informes sugieren una situacion en la que la asistencia policial inmediata es crucial para investigar y abordar una posible actividad de trafico de drogas.",
    },                            
