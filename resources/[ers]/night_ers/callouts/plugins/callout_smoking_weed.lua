Config.Callouts["smoking_weed"] = {
    ...
    CalloutDescriptions = {
        "Investigar informes de una persona fumando marihuana; localizar al individuo y evaluar la situacion.",
        "Alerta: enviar unidades para verificar informes de consumo de marihuana en un area publica; velar por el cumplimiento de las leyes.",
        "Unidades requeridas: responder a informes de alguien fumando marihuana y evaluar las circunstancias.",
        "Aviso: consultar informes de una persona consumiendo marihuana; tomar las medidas necesarias para mantener el orden publico.",
        "Alerta: responder con prontitud a los informes de consumo de marihuana; priorizar la seguridad de la comunidad y la evaluacion adecuada.",
        "Incidente reportado: consulte los informes de una persona fumando marihuana para comprender el contexto y la legalidad.",
        "Investigar informes de consumo de marihuana; Coordinar con las autoridades locales para abordar la situacion.",
        "Alerta de situacion: abordar informes de una persona fumando marihuana; trabajar con las autoridades pertinentes si es necesario.",
        "Alerta: manejar informes de consumo de marihuana y cumplir con los protocolos para garantizar la seguridad publica y el cumplimiento.",
        "Se necesita respuesta: investigar los informes de una persona fumando marihuana y tomar medidas para garantizar que se respeten los estandares comunitarios.",
    },  
