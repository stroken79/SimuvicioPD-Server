...
LsdotUniforms['jefe_operaciones'] = {
    male = {
        components = {
            [11] = { 318, 0 },  -- Chaqueta / Top
            [4]  = { 221, 2 },  -- Pantalon
            [3]  = { 11, 0 },   -- Brazos / Torso
            [9]  = { 0, 0 },    -- Chaleco / Armor
            [8]  = { 257, 0 },  -- Camiseta / Interior
            [7]  = { 38, 0 },   -- Accesorios
            [6]  = { 111, 0 },  -- Zapatos
            [10] = { 0, 0 },    -- Insignias / Decals
            [5]  = { 0, 0 }     -- Bolsas
