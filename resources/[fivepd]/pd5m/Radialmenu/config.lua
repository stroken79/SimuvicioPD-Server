            ...
            wheels = {                              -- Array of wheels to display
                {
                    ...
                    labels = {"ALCOHOLEMIA", "SEGUIR", "", "ESPOSAR", "MULTAR"},
                ...
                },
                {
                    ...
                    labels = {"TEST DROGAS", "MATRÍCULA", "IDENTIFICAR", "FORENSE", "GRÚA", "AGARRAR", "METER EN PATR.", "INCAUTAR VEHIC.", "CONFIS. OBJETOS", "REGISTRAR"},
            ...
            wheels = {                              -- Array of wheels to display
                {
                    ...
                    maxRadiusPercent = 0.9,         -- Maximum radius of wheel in percentage
                    labels = {"MATRÍCULA", "IDENTIFICAR", "DAR EL ALTO", "SACAR DETENIDO"},
