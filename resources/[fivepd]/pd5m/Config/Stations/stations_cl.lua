...
-- Help-coords init
list_help_coords = {}
for i, Station in ipairs(Stations or {}) do
  for j, helppoint in ipairs((Station.markers and Station.markers.help) or {}) do
...
list_weap_coords = {}
for i, Station in ipairs(Stations) do
  for j, weappoint in ipairs((Station.markers and Station.markers.weap) or {}) do
