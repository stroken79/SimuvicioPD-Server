...
if false then
		...
		while true do
			for i,coord in ipairs(list_cloth_coords) do
				...
				if distance < 5 then
					...
					atcloth = true
					StartHelpNotify('Pulsa ~INPUT_CONTEXT~ para abrir el vestuario.', 500)
					Wait(40)
					while distance < 5 do
						HelpNotify('Pulsa ~INPUT_CONTEXT~ para abrir el vestuario.', 500)
						Wait(500)
						local player_x, player_y, player_z = table.unpack(GetEntityCoords(PlayerPedId(), false))
						distance = Vdist2(coord.x, coord.y, coord.z, player_x, player_y, player_z)
					end
					EndHelpNotify('Pulsa ~INPUT_CONTEXT~ para abrir el vestuario.', 500)
					atcloth = false
					clothlocation = nil
					clothpolice = nil
					WarMenu.CloseMenu()
	...
	CreateThread(function()
		...
		WarMenu.CreateMenu('WardrobeMain', 'Vestuario')
		WarMenu.CreateSubMenu('WardrobeStandard', 'WardrobeMain', 'Vestuario') -- change Shirt, Legs and Shoes (components 11, 4, 6)
		WarMenu.CreateSubMenu('WardrobeAccessoires', 'WardrobeMain', 'Vestuario') -- change all props, components 1,3,5,7,10
		WarMenu.CreateSubMenu('WardrobeHeadgear', 'WardrobeAccessoires', 'Vestuario') -- Props 0, 1, 2, Component 1
		WarMenu.CreateSubMenu('WardrobeBody', 'WardrobeAccessoires', 'Vestuario') -- Props 6, 7, Component 3
		WarMenu.CreateSubMenu('WardrobeMisc', 'WardrobeAccessoires', 'Vestuario') -- Components 5, 7, 10
		WarMenu.CreateSubMenu('WardrobeUndress', 'WardrobeMain', 'Vestuario') -- undress options for every item
		WarMenu.CreateSubMenu('WardrobeUndershirt', 'WardrobeStandard', 'Vestuario') -- change components 8, 9
		WarMenu.CreateSubMenu('WardrobeSavedOutfits', 'WardrobeMain', 'Vestuario')
		WarMenu.CreateSubMenu('WardrobeLoadOutfit', 'WardrobeSavedOutfits', 'Vestuario')
		WarMenu.CreateSubMenu('WardrobeDeleteOutfit', 'WardrobeSavedOutfits', 'Vestuario')

		while true do
			if WarMenu.IsMenuOpened('WardrobeMain') then
				if WarMenu.MenuButton('Uniforme', 'WardrobeStandard') then
				...
				elseif WarMenu.MenuButton('Accesorios', 'WardrobeAccessoires') then
				elseif WarMenu.MenuButton('Quitarse el uniforme', 'WardrobeUndress') then
				elseif WarMenu.MenuButton('Conjuntos guardados', 'WardrobeSavedOutfits') then
				elseif WarMenu.Button('Salir del menú') then
					WarMenu.CloseMenu()
				end
				WarMenu.Display()
			elseif WarMenu.IsMenuOpened('WardrobeStandard') then
				if WarMenu.ComboBox("Rangos", RankList, RankCurrentIndex, RankSelectedIndex, function(currentIndex, selectedIndex)
				...
				elseif WarMenu.ComboBox('Categoría superior', ListWarMenuCloth[1][11].Categories, TopCategoryCurrentIndex, TopCategorySelectedIndex, function(currentIndex, selectedIndex)
				...
				elseif WarMenu.ComboBox('Prenda superior', ListWarMenuCloth[1][11].Items[TopCategorySelectedIndex], TopItemCurrentIndex, TopItemSelectedIndex, function(currentIndex, selectedIndex)
				...
				elseif WarMenu.ComboBox('Opción superior', TopOptionNameList, TopOptionCurrentIndex, TopOptionSelectedIndex, function(currentIndex, selectedIndex)
				...
				elseif WarMenu.ComboBox('Categoría de pantalón', ListWarMenuCloth[1][4].Categories, PantsCategoryCurrentIndex, PantsCategorySelectedIndex, function(currentIndex, selectedIndex)
				...
				elseif WarMenu.ComboBox('Pantalón', ListWarMenuCloth[1][4].Items[PantsCategorySelectedIndex], PantsItemCurrentIndex, PantsItemSelectedIndex, function(currentIndex, selectedIndex)
				...
				elseif WarMenu.ComboBox('Opción de pantalón', PantsOptionNameList, PantsOptionCurrentIndex, PantsOptionSelectedIndex, function(currentIndex, selectedIndex)
				...
				elseif WarMenu.ComboBox('Categoría de calzado', ListWarMenuCloth[1][6].Categories[LegCategories[PantsCategory].ShoesCategory], ShoesCategoryCurrentIndex, ShoesCategorySelectedIndex, function(currentIndex, selectedIndex)
				...
				elseif WarMenu.ComboBox('Calzado', ListWarMenuCloth[1][6].Items[LegCategories[PantsCategory].ShoesCategory][ShoesCategorySelectedIndex], ShoesItemCurrentIndex, ShoesItemSelectedIndex, function(currentIndex, selectedIndex)
				...
				elseif WarMenu.ComboBox('Opción de calzado', ShoesOptionNameList, ShoesOptionCurrentIndex, ShoesOptionSelectedIndex, function(currentIndex, selectedIndex)
				...
				elseif WarMenu.MenuButton('Elegir accesorios', 'WardrobeUndershirt') then
				...
				elseif WarMenu.MenuButton('Volver al menú principal', 'WardrobeMain') then
				end
				WarMenu.Display()
			elseif WarMenu.IsMenuOpened('WardrobeUndershirt') then

				if WarMenu.ComboBox('Categoría extra 1', ListWarMenuCloth[1][8].Categories[TopCategories[TopCategory].UndershirtCategory], UndershirtCategoryCurrentIndex, UndershirtCategorySelectedIndex, function(currentIndex, selectedIndex)
				...
				elseif WarMenu.ComboBox('Artículo extra 1', ListWarMenuCloth[1][8].Items[TopCategories[TopCategory].UndershirtCategory][UndershirtCategorySelectedIndex], UndershirtItemCurrentIndex, UndershirtItemSelectedIndex, function(currentIndex, selectedIndex)
				...
				elseif WarMenu.ComboBox('Opción extra 1', UndershirtOptionNameList, UndershirtOptionCurrentIndex, UndershirtOptionSelectedIndex, function(currentIndex, selectedIndex)
				...
				elseif WarMenu.ComboBox('Categoría extra 2', ListWarMenuCloth[1][9].Categories[TopCategories[TopCategory].KevlarCategory], KevlarCategoryCurrentIndex, KevlarCategorySelectedIndex, function(currentIndex, selectedIndex)
				...
				elseif WarMenu.ComboBox('Artículo extra 2', ListWarMenuCloth[1][9].Items[TopCategories[TopCategory].KevlarCategory][KevlarCategorySelectedIndex], KevlarItemCurrentIndex, KevlarItemSelectedIndex, function(currentIndex, selectedIndex)
				...
				elseif WarMenu.ComboBox('Opción extra 2', KevlarOptionNameList, KevlarOptionCurrentIndex, KevlarOptionSelectedIndex, function(currentIndex, selectedIndex)
			...
			elseif WarMenu.IsMenuOpened('WardrobeAccessoires') then
				if WarMenu.MenuButton('Guantes y muñecas', 'WardrobeBody') then
				...
				elseif WarMenu.MenuButton('Accesorios de cabeza', 'WardrobeHeadgear') then
				...
				elseif WarMenu.MenuButton('Otro equipamiento', 'WardrobeMisc') then
			...
			elseif WarMenu.IsMenuOpened('WardrobeHeadgear') then
				if WarMenu.ComboBox('Categoría de cabeza', ListWarMenuCloth[2][0].Categories, HeadgearCategoryCurrentIndex, HeadgearCategorySelectedIndex, function(currentIndex, selectedIndex)
				...
				elseif WarMenu.ComboBox('Accesorio de cabeza', ListWarMenuCloth[2][0].Items[HeadgearCategorySelectedIndex], HeadgearItemCurrentIndex, HeadgearItemSelectedIndex, function(currentIndex, selectedIndex)
				...
				elseif WarMenu.ComboBox('Opción de cabeza', HeadgearOptionNameList, HeadgearOptionCurrentIndex, HeadgearOptionSelectedIndex, function(currentIndex, selectedIndex)
				...
				elseif WarMenu.ComboBox('Categoría de máscara', ListWarMenuCloth[1][1].Categories, MaskCategoryCurrentIndex, MaskCategorySelectedIndex, function(currentIndex, selectedIndex)
				...
				elseif WarMenu.ComboBox('Máscara', ListWarMenuCloth[1][1].Items[MaskCategorySelectedIndex], MaskItemCurrentIndex, MaskItemSelectedIndex, function(currentIndex, selectedIndex)
				...
				elseif WarMenu.ComboBox('Opción de máscara', MaskOptionNameList, MaskOptionCurrentIndex, MaskOptionSelectedIndex, function(currentIndex, selectedIndex)
				...
				elseif WarMenu.ComboBox('Categoría de gafas', ListWarMenuCloth[2][1].Categories, GlassesCategoryCurrentIndex, GlassesCategorySelectedIndex, function(currentIndex, selectedIndex)
				...
				elseif WarMenu.ComboBox('Gafas', ListWarMenuCloth[2][1].Items[GlassesCategorySelectedIndex], GlassesItemCurrentIndex, GlassesItemSelectedIndex, function(currentIndex, selectedIndex)
				...
				elseif WarMenu.ComboBox('Opción de gafas', GlassesOptionNameList, GlassesOptionCurrentIndex, GlassesOptionSelectedIndex, function(currentIndex, selectedIndex)
				...
				elseif WarMenu.ComboBox('Categoría de oreja', ListWarMenuCloth[2][2].Categories, EarCategoryCurrentIndex, EarCategorySelectedIndex, function(currentIndex, selectedIndex)
				...
				elseif WarMenu.ComboBox('Accesorio de oreja', ListWarMenuCloth[2][2].Items[EarCategorySelectedIndex], EarItemCurrentIndex, EarItemSelectedIndex, function(currentIndex, selectedIndex)
				...
				elseif WarMenu.ComboBox('Opción de oreja', EarOptionNameList, EarOptionCurrentIndex, EarOptionSelectedIndex, function(currentIndex, selectedIndex)
			...
			elseif WarMenu.IsMenuOpened('WardrobeBody') then
				...
				if WarMenu.ComboBox('Estilo de guantes', ListGloveStyles, GloveStyleCurrentIndex, GloveStyleSelectedIndex, function(currentIndex, selectedIndex)
						GloveStyleCurrentIndex = currentIndex
						selectedIndex = currentIndex
						GloveStyleSelectedIndex = selectedIndex
					end) then

				elseif WarMenu.ComboBox('Color de guantes', ListGloveColors[GloveStyleSelectedIndex], GloveColorCurrentIndex, GloveColorSelectedIndex, function(currentIndex, selectedIndex)
				...
				elseif WarMenu.ComboBox('Tipo de cuerpo', BodyStyleList, BodyTypeCurrentIndex, BodyTypeSelectedIndex, function(currentIndex, selectedIndex)
				...
				elseif WarMenu.ComboBox('Categoría de reloj', ListWarMenuCloth[2][6].Categories, WatchCategoryCurrentIndex, WatchCategorySelectedIndex, function(currentIndex, selectedIndex)
				...
				elseif WarMenu.ComboBox('Reloj', ListWarMenuCloth[2][6].Items[WatchCategorySelectedIndex], WatchItemCurrentIndex, WatchItemSelectedIndex, function(currentIndex, selectedIndex)
				...
				elseif WarMenu.ComboBox('Opción de reloj', WatchOptionNameList, WatchOptionCurrentIndex, WatchOptionSelectedIndex, function(currentIndex, selectedIndex)
				...
				elseif WarMenu.ComboBox('Categoría de pulsera', ListWarMenuCloth[2][7].Categories, BraceletCategoryCurrentIndex, BraceletCategorySelectedIndex, function(currentIndex, selectedIndex)
				...
				elseif WarMenu.ComboBox('Pulsera', ListWarMenuCloth[2][7].Items[BraceletCategorySelectedIndex], BraceletItemCurrentIndex, BraceletItemSelectedIndex, function(currentIndex, selectedIndex)
				...
				elseif WarMenu.ComboBox('Opción de pulsera', BraceletOptionNameList, BraceletOptionCurrentIndex, BraceletOptionSelectedIndex, function(currentIndex, selectedIndex)
			...
			elseif WarMenu.IsMenuOpened('WardrobeSavedOutfits') then
				...
				elseif WarMenu.MenuButton('Cargar conjunto', 'WardrobeLoadOutfit') then
					LoadOutfitCurrentIndex = 1
					LoadOutfitSelectedIndex = 1
				elseif WarMenu.MenuButton('Eliminar conjunto', 'WardrobeDeleteOutfit') then
			...
			elseif IsControlJustPressed(0, 51) and atcloth and PlayerData.job.name == 'police' then
				...
				elseif GetEntityModel(playerped) == GetHashKey('mp_f_freemode_01') then
					...
					Notify('Necesitas un personaje multijugador para usar el vestuario.')
				end
			end
			Wait(0)
		end
	...
	CreateThread(function()
		while true do
			for i,coord in ipairs(list_heal_coords) do
				...
				if distance < 5 then
					atheal = true
					StartHelpNotify('Pulsa ~INPUT_CONTEXT~ para curarte.', 500)
					Wait(40)
					while distance < 5 do
						HelpNotify('Pulsa ~INPUT_CONTEXT~ para curarte.', 500)
						Wait(500)
						local player_x, player_y, player_z = table.unpack(GetEntityCoords(PlayerPedId(), false))
						distance = Vdist2(coord.x, coord.y, coord.z, player_x, player_y, player_z)
					end
					EndHelpNotify('Pulsa ~INPUT_CONTEXT~ para curarte.', 500)
					atheal = false
				end
			end
		Wait(1000)
...
if ActivateGarages then
		...
		while true do
			for i,coord in ipairs(list_cars_coords) do
				...
				if distance < 5 then
					...
					atgarage = true
					StartHelpNotify('Pulsa ~INPUT_CONTEXT~ para abrir el garaje.', 500)
					Wait(40)
					while distance < 5 do
						HelpNotify('Pulsa ~INPUT_CONTEXT~ para abrir el garaje.', 500)
						Wait(500)
						local player_x, player_y, player_z = table.unpack(GetEntityCoords(PlayerPedId(), false))
						distance = Vdist2(coord.x, coord.y, coord.z, player_x, player_y, player_z)
					end
					EndHelpNotify('Pulsa ~INPUT_CONTEXT~ para abrir el garaje.', 500)
					atgarage = false
					garagelocation = nil
					garagepolice = nil
					WarMenu.CloseMenu()
	...
	CreateThread(function()
		...
		WarMenu.CreateMenu('Garaje', 'Garaje')
		WarMenu.CreateSubMenu('Personalización', 'Garaje', 'Personalización')

		while true do
			if WarMenu.IsMenuOpened('Garaje') then
				for i, Carname in ipairs(ListWarMenuGarage[2]) do
					if WarMenu.MenuButton(Carname, 'Personalización') then
				...
				if WarMenu.Button('Salir del menú') then
					WarMenu.CloseMenu()
				end
				WarMenu.Display()
			elseif WarMenu.IsMenuOpened('Personalización') then
				if WarMenu.ComboBox('Tipo de matrícula', LicensePlateTypeList, LicensePlateCurrent, LicensePlateSelected, function(currentIndex, selectedIndex)
				...
				elseif LicensePlateTextList[1] == 'Custom' then
					if WarMenu.Button('Texto de matrícula') then
                        LicensePlateTextHead = "Texto de matrícula (máximo 8 caracteres)"
				...
				if WarMenu.ComboBox('Color principal', PrimaryColorsNames, PrimaryColorsCurrent, PrimaryColorsSelected, function(currentIndex, selectedIndex)
				...
				elseif WarMenu.ComboBox('Color secundario', SecondaryColorsNames, SecondaryColorsCurrent, SecondaryColorsSelected, function(currentIndex, selectedIndex)
				...
				if #LiveryNames > 0 then
					if WarMenu.ComboBox('Diseño', LiveryNames, LiveryCurrent, LiverySelected, 	function(currentIndex, selectedIndex)
				...
				if WarMenu.Button('Sacar vehículo', ChosenCarName) then
					...
					WarMenu.CloseMenu()
				elseif WarMenu.MenuButton('Go back to list', 'Garaje') then
				end
				WarMenu.Display()
...
if ActivateWeaponMarkers then
		...
		while true do
			for i,coord in ipairs(list_weap_coords) do
				...
				if distance < 5 then
					...
					atweapon = true
					StartHelpNotify('Pulsa ~INPUT_CONTEXT~ para abrir la armería.', 500)
					Wait(40)
					while distance < 5 do
						HelpNotify('Pulsa ~INPUT_CONTEXT~ para abrir la armería.', 500)
						Wait(500)
						local player_x, player_y, player_z = table.unpack(GetEntityCoords(PlayerPedId(), false))
						distance = Vdist2(coord.x, coord.y, coord.z, player_x, player_y, player_z)
					end
					EndHelpNotify('Pulsa ~INPUT_CONTEXT~ para abrir la armería.', 500)
					atweapon = false
					weaponlocation = nil
					weaponpolice = nil
					WarMenu.CloseMenu()
	...
	CreateThread(function()
		...
		WarMenu.CreateMenu('Armería', 'Armería')
		WarMenu.CreateSubMenu('Armas', 'Armería', 'Armas')
		WarMenu.CreateSubMenu('AttachmentsW', 'Armas', 'Attachments')
		WarMenu.CreateSubMenu('AttachmentsE', 'Equipamiento', 'Attachments')
		WarMenu.CreateSubMenu('Equipamiento', 'Armería', 'Equipamiento')

		while true do
			if WarMenu.IsMenuOpened('Armería') then
				if WarMenu.MenuButton('Armas', 'Armas') then
					VestCurrentIndex = 1
					VestSelectedIndex = 1
					VestDesignCurrentIndex = 1
					VestDesignSelectedIndex = 1
				elseif WarMenu.MenuButton('Equipamiento', 'Equipamiento') then
					VestCurrentIndex = 1
					VestSelectedIndex = 1
					VestDesignCurrentIndex = 1
					VestDesignSelectedIndex = 1
				elseif WarMenu.Button('Devolver todas las armas') then
					RemoveAllPedWeapons(GetPlayerPed(-1), true)
				elseif WarMenu.Button('Salir del menú') then
					WarMenu.CloseMenu()
				end
				WarMenu.Display()
			elseif WarMenu.IsMenuOpened('Armas') then
				SelectedWeapon = nil
				AttachmentBoolList = {}
				VestList = {
					data = {},
    ...
    print("PERMITIDA")
        ...
        elseif weapon.armor.IsArmor then
			...
			elseif WarMenu.IsMenuOpened('AttachmentsW') then
				...
				if WarMenu.MenuButton('Volver a la lista de armas', 'Armas') then
				end
				WarMenu.Display()
			elseif WarMenu.IsMenuOpened('Equipamiento') then
				SelectedWeapon = nil
				AttachmentBoolList = {}
				VestList = {
					data = {},
        ...
        elseif weapon.armor.IsArmor then
            ...
            if WarMenu.Button(weapon.name) then
				...
				if #VestList.data > 0 then
					...
					elseif WarMenu.ComboBox('Diseño del chaleco', VestDesignList.index, VestDesignCurrentIndex, VestDesignSelectedIndex, function(currentIndex, selectedIndex)
			...
			elseif WarMenu.IsMenuOpened('AttachmentsE') then
				...
				if WarMenu.MenuButton('Volver a la lista de equipamiento', 'Equipamiento') then
				end
				WarMenu.Display()
	...
	CreateThread(function()
		while true do
			for i,coord in ipairs(list_evidence_coords) do
				...
				if distance < 5 then
					atevidence = true
					StartHelpNotify('Pulsa ~INPUT_CONTEXT~ para entregar las pruebas.', 500)
					Wait(40)
					while distance < 5 do
						HelpNotify('Pulsa ~INPUT_CONTEXT~ para entregar las pruebas.', 500)
						Wait(500)
						local player_x, player_y, player_z = table.unpack(GetEntityCoords(PlayerPedId(), false))
						distance = Vdist2(coord.x, coord.y, coord.z, player_x, player_y, player_z)
					end
					EndHelpNotify('Pulsa ~INPUT_CONTEXT~ para entregar las pruebas.', 500)
					atevidence = false
				end
			end
		Wait(1000)
	...
	CreateThread(function()
		while true do
			if IsControlJustPressed(0, 51) and atevidence == true then -- e
				...
				AddTextComponentSubstringPlayerName("Has entregado ~y~" .. NoItems .. "~s~ objetos confiscados en la sala de pruebas.")
				EndTextCommandThefeedPostMessagetext("CHAR_CALL911", "CHAR_CALL911", false, 4, "Informe de pruebas", "")
	...
	CreateThread(function()
		while true do
			for i,coord in ipairs(list_repair_coords) do
				...
				if distance < 10 then
					atrepair = true
					StartHelpNotify('Pulsa ~INPUT_CONTEXT~ para reparar y limpiar tu vehículo.', 500)
					Wait(40)
					while distance < 10 do
						HelpNotify('Pulsa ~INPUT_CONTEXT~ para reparar y limpiar tu vehículo.', 500)
						Wait(500)
						local player_x, player_y, player_z = table.unpack(GetEntityCoords(PlayerPedId(), false))
						distance = Vdist2(coord.x, coord.y, coord.z, player_x, player_y, player_z)
					end
					EndHelpNotify('Pulsa ~INPUT_CONTEXT~ para reparar y limpiar tu vehículo.', 500)
					atrepair = false
				end
			end
		Wait(1000)
	...
	CreateThread(function()
		while true do
			for i,coord in ipairs(list_delete_coords) do
				...
				if distance < 10 then
					atdelete = true
					StartHelpNotify('Mira a un vehículo y pulsa ~INPUT_CONTEXT~ para enviarlo al depósito / eliminarlo.', 500)
					Wait(40)
					while distance < 10 do
						HelpNotify('Mira a un vehículo y pulsa ~INPUT_CONTEXT~ para enviarlo al depósito / eliminarlo.', 500)
						Wait(500)
						local player_x, player_y, player_z = table.unpack(GetEntityCoords(PlayerPedId(), false))
						distance = Vdist2(coord.x, coord.y, coord.z, player_x, player_y, player_z)
					end
					EndHelpNotify('Mira a un vehículo y pulsa ~INPUT_CONTEXT~ para enviarlo al depósito / eliminarlo.', 500)
					atdelete = false
				end
			end
		Wait(1000)
		...
		while true do
			if IsControlJustPressed(0, 51) and atdelete == true then -- e
				...
				if not IsPedInAnyVehicle(playerped, false) then
					...
					Notify('Sal del vehículo para enviarlo al depósito.')
				end
			end
		Wait(0)
		end
	...
	CreateThread(function()
		while true do
			for i,coord in ipairs(list_tpmarker_coords) do
				...
				if distance < 5 then
					attpmarker = true
					StartHelpNotify('Pulsa ~INPUT_CONTEXT~ para viajar a otra comisaría.', 500)
					Wait(40)
					while distance < 5 do
						HelpNotify('Pulsa ~INPUT_CONTEXT~ para viajar a otra comisaría.', 500)
						Wait(500)
						local player_x, player_y, player_z = table.unpack(GetEntityCoords(PlayerPedId(), false))
						distance = Vdist2(coord.x, coord.y, coord.z, player_x, player_y, player_z)
					end
					EndHelpNotify('Pulsa ~INPUT_CONTEXT~ para viajar a otra comisaría.', 500)
					attpmarker = false
				end
			end
		Wait(1000)
	...
	CreateThread(function()
		while true do
			for i,coord in ipairs(list_help_coords) do
				...
				if distance < 5 then
					athelp = true
					StartHelpNotify('Pulsa ~INPUT_CONTEXT~ para mostrar los controles.', 500)
					Wait(40)
					while distance < 5 do
						HelpNotify('Pulsa ~INPUT_CONTEXT~ para mostrar los controles.', 500)
						Wait(500)
						local player_x, player_y, player_z = table.unpack(GetEntityCoords(PlayerPedId(), false))
						distance = Vdist2(coord.x, coord.y, coord.z, player_x, player_y, player_z)
					end
					EndHelpNotify('Pulsa ~INPUT_CONTEXT~ para mostrar los controles.', 500)
					athelp = false
				end
			end
		Wait(1000)
		...
		while true do
			if IsControlJustPressed(0, 51) and athelp == true then -- e
				...
				if IsInputDisabled(2) then
					BeginTextCommandThefeedPost("TWOSTRINGS")
					AddTextComponentSubstringPlayerName("Pulsa ~g~E~s~ mientras miras a una persona para hablar con ella.")
					EndTextCommandThefeedPostTicker(false, false)
					...
					BeginTextCommandThefeedPost("TWOSTRINGS")
					AddTextComponentSubstringPlayerName("Pulsa ~g~DPad Derecho~s~ mientras miras a una persona para hablar con ella.")
					EndTextCommandThefeedPostTicker(false, false)

					BeginTextCommandThefeedPost("TWOSTRINGS")
					AddTextComponentSubstringPlayerName("Pulsa ~r~DPad Abajo~s~ para ver las acciones disponibles. Usa el stick analogico")
                    AddTextComponentSubstringPlayerName("para mover el cursor sobre una opcion. Pulsa DPad Abajo para realizarla.")
					EndTextCommandThefeedPostTicker(false, false)
				end
				...
				BeginTextCommandThefeedPost("TWOSTRINGS")
				AddTextComponentSubstringPlayerName("Escribe ~o~/tp~s~ en el chat para abrir el menu de teletransporte.")
				EndTextCommandThefeedPostTicker(false, false)
