...
local function ShowHoseHelpText(message)
    ...
    while true do
        ...
        if vehicle then
            if IsFireHoseEquipped() then
                ShowHoseHelpText('Pulsa ~INPUT_VEH_HEADLIGHT~ para guardar la manguera')
            else
                ShowHoseHelpText('Pulsa ~INPUT_VEH_HEADLIGHT~ para sacar la manguera')
            end
        end
